...
const HeroSection = () => {
  return (
    <section className="pt-20 md:pt-32 pb-12 md:pb-24 px-4 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="order-2 md:order-1 z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                className="text-base sm:text-lg bg-brand-blue hover:bg-brand-blue/90 px-6 py-5 sm:px-8 sm:py-6"
              ...
              <Button 
                variant="outline" 
                className="text-base sm:text-lg border-brand-blue text-brand-blue hover:bg-brand-blue/10 px-6 py-5 sm:px-8 sm:py-6"
          ...
          <div className="order-1 md:order-2 relative mb-8 md:mb-0">
            ...
            <div className="absolute top-0 right-0 w-48 h-48 sm:w-64 sm:h-64 bg-brand-teal/30 rounded-full filter blur-3xl -z-10 animate-pulse"></div>
            <div className="absolute bottom-0 left-0 w-48 h-48 sm:w-64 sm:h-64 bg-brand-orange/30 rounded-full filter blur-3xl -z-10 animate-pulse"></div>
          </div>
        </div>
      ...
      {/* Floating icons - now only visible on larger screens */}
      ...
      <div className="absolute top-0 right-0 w-1/3 h-1/3 pattern-dots opacity-10 sm:opacity-20"></div>
      <div className="absolute bottom-0 left-0 w-1/3 h-1/3 pattern-dots opacity-10 sm:opacity-20"></div>
    </section>
  );
};
