...
> = {
  uk: {
    ...
    stats: [
      ...
      { value: 'від 1', label: 'тижня на запуск лендінгу' },
    ...
    pricingTeaserLead: 'Два пакети під різні завдання плюс додаткові послуги. Без прихованих доплат.',
  ...
  en: {
    ...
    stats: [
      ...
      { value: 'from 1', label: 'week to launch a landing page' },
    ...
    pricingTeaserLead: 'Two packages for different goals, plus extra services. No hidden extras.',
  ...
  pl: {
    ...
    stats: [
      ...
      { value: 'od 1', label: 'tygodnia na start landingu' },
    ...
    pricingTeaserLead: 'Dwa pakiety pod różne cele oraz usługi dodatkowe. Bez ukrytych dopłat.',
